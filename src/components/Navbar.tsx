  ...
  return (
    <nav className="w-full bg-[#083462] shadow-md p-4 flex justify-between items-center text-white z-20">
      ...
      <div className="hidden md:flex items-center gap-8 text-white/90">
        ...
        {isAuthenticated ? (
          <>
            <Link href="/tutor" className="hover:text-white transition-colors">Tutor Area</Link>
            <Link href="/admin" className="hover:text-white transition-colors">Admin Area</Link>
          </>
        ) : (
          <>
